...
describe("types", function() {
    ...
    it("type_id sort", function() {
        ...
        assert.deepEqual(
            t.fromObject([[1, 1], [0, 0]]),
            [[0, 0], [1, 1]],
            "did not sort"
        );
        assert.deepEqual(
            t.fromObject([[0, 0], [1, 1]]),
            [[0, 0], [1, 1]],
            "did not sort"
        );
    });
    ...
    return it("precision number long", function() {
        ...
        assert.equal(
            ...
            p
                .to_bigint64(Long.MAX_VALUE.toString(), (_precision = 0))
                .toString(),
        ...
        overflow(function() {
            return p.to_bigint64("18446744073709551616", (_precision = 0));
        });
        ...
        overflow(function() {
            return p.to_bigint64("184467440737095516155", (_precision = 1));
        });
    });
});
